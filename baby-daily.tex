...
%\NewDocumentCommand{\PageLayout}{mmm}{%
  \noindent%
  \begin{minipage}[.55\textheight]{\textwidth}#1\end{minipage}%
  \vfill%
  \noindent%
  \begin{minipage}[.35\textheight]{.47\textwidth}#2\end{minipage}%
  \hfill%
  \begin{minipage}[.35\textheight]{.47\textwidth}#3\end{minipage}%
}
