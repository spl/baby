...
\NewDocumentCommand{\TableWithHeaderAndReplicatedRows}{mmm}{
...
\PageLayout{%%%%% Top %%%%%
  ...
  \TableWithHeaderAndReplicatedRows{l l L l L l}{%
    Type &
    Initial &
    Time &
    Remaining &
  ...
  \SectionHeader{Nanny's Extra Duties}

  \Instructions{Check the box for the required duty.
  Fill in any unspecified information or duties.}
  ...
  \begin{tabularx}{\textwidth}{ l L }
    \Checkbox & Sweep rooms:~\hrulefill \\
    \Checkbox & Mop rooms:~\hrulefill \\
    \Checkbox & Iron clothes \\
    \Checkbox & \hrulefill \\
    \Checkbox & \hrulefill \\
    \Checkbox & \hrulefill \\
    \Checkbox & \hrulefill \\
